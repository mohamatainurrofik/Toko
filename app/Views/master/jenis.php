    ...
    <div class="container" id="kt_content_container">
        ...
        <div class="card ">
            <div class="card-header">
                <h3 class="card-title">Master Jenis Obat</h3>
                <div class="card-toolbar">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                        <div class="menu-item px-3">
                            <a type="button" href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#modaltambahjenis">
                                Tambah
                            </a>
                        </div>
                        <div class="menu-item px-3">
                            <a href="#" class="menu-link px-3" id="btn-lihat-modal-sampah-jenis" data-bs-toggle="modal" data-bs-target="#modalsampahjenis">
                                Lihat Sampah
                            </a>
                        </div>
                    </div>
            ...
            <div class="card-body p-lg-17">
                ...
                <div class="mb-18">
                    ...
                    <div class="mb-10">
                        <table id="table_jenis_obat" class="table table-hover table-row-bordered gy-5 gs-7  gx-7">
                            <thead>
